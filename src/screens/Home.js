    ...
    function renderHeader() {
        return (
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.white }}>
                <View>
                    <Text style={{ color: COLORS.primary, ...FONTS.h2 }}>Pocket Pulse</Text>
    ...
    function renderCategoryList() {
        ...
        return (
            <View style={{ paddingHorizontal: SIZES.padding - 5 }}>
                ...
                >
                    <Text style={{ ...FONTS.body2 }}>{showMoreToggle ? "Hide Categories" : "Show Categories"}</Text>
                    <Image
                        source={showMoreToggle ? icons.up_arrow : icons.down_arrow}
                        style={{ marginLeft: 5, width: 17, height: 17, alignSelf: 'center' }}
                    />
                </TouchableOpacity>
            </View>
        )
        ...
        else
        {
            ...
            return (
                <View  style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ position: 'absolute', top: '42%', left: "42%", backgroundColor:COLORS.primary, borderRadius:5 }}>
                      <TouchableOpacity onPress={toggleModal}>
                      <ModalTester isVisible={isModalVisible} onClose={onClose}  />
                        <Text style={{ ...FONTS.h1, textAlign: 'center' }}> Add </Text>
